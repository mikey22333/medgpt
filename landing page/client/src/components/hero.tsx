      ...
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-16">
            <Button size="lg" className="medical-gradient text-white px-8 py-4 text-lg font-semibold hover:scale-105 transition-transform">
              <Rocket className="w-5 h-5 mr-2" />
              Try for Free
            </Button>
            <Button size="lg" variant="outline" className="px-8 py-4 text-lg font-semibold border-2 border-primary/20 hover:border-primary/40">
